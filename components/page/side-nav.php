...
<aside id="mainNav" class="main-nav">
  ...
  <div class="bottomNav">
    <ul>
      ...
      <li title="Logout" > <span class='no-show' data-i18n-key="logout" >Logout</span>
        <a title="Logout" href="<?= wp_logout_url() ?>"> 
          <svg id="_9026001_sign_out_icon" data-name="9026001_sign_out_icon" xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 256 256">
            <rect id="Rectangle_66" data-name="Rectangle 66" width="256" height="256" fill="none"/>
            <path id="Path_91" data-name="Path 91" d="M174,86l42,42-42,42" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
            <line id="Line_3" data-name="Line 3" x2="112" transform="translate(104 128)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
            <path id="Path_92" data-name="Path 92" d="M112.787,216H49.1c-5.025,0-9.1-3.582-9.1-8V48c0-4.418,4.073-8,9.1-8h63.689" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>
          </svg>
        </a>
      </li>
      <li title="My Account" > <span class='no-show' data-i18n-key="my-account" >My Account</span> <a title="My Account" class="<?php echo $isAccount ? 'active' : '' ?>" href="<?php echo site_url( '/my-account' ) ?>"><?php get_template_part( 'svg-template/svg', 'icon_user' ) ?></a></li>
    </ul>
  </div>
</aside>
